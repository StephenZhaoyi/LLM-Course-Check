...
file1 = client.files.create(
    file=open(r"candidate_data/applicant_excel.pdf", "rb"),
    purpose='assistants'
)
...
applicant_template_path = r'backend/data/applicant_info_template.json'
...
courses_template_path = r'backend/data/excel_json_template.json'
...
def write_to_json(ai_answer):
    ...
    with open(r"backend/read_excel_output/applicant_info.json", "w") as applicant_file:
        json.dump(applicant_json, applicant_file, indent=4)

    with open(r"backend/read_excel_output/converted_excel.json", "w") as course_file:
